...
$expectedRepository = 'spyfu/siteaudit-demo-home-services'
$expectedRemoteHttps = 'https://github.com/spyfu/siteaudit-demo-home-services.git'
$expectedRemoteSsh = 'git@github.com:spyfu/siteaudit-demo-home-services.git'
